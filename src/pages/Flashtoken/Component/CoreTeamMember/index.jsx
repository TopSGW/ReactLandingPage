          ...
          <Grid item xs={12} md={4} sm={12}>
            <Box className="member_core">
              ...
              <Box sx={{ ml: "14px", mt: "15px" }}>
                ...
                >
                  CEO & Founder of <br />{" "}
                  <span className="colored-text">Smartblocklabs </span> &{" "}
            ...
            <img src={core2} className="core_member" />
              <Box sx={{ ml: "14px", mt: "15px" }}>
                ...
                >
                  ...
                  & with <span className="colored-text">Travladd </span>{" "}
                  Influencer
                </Typography>
                <Box mt="10px">
                  <a
            ...
            <img src={core1} className="core_member" />
                ...
                >
                  ...
                  <span className="colored-text">
                    consultant in web marketing strategy{" "}
                  </span>{" "}
                  and{" "}

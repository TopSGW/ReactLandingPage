...
import PitchDeckCTA from "../../../../assests/Images/Whitepaper-en (1).png";
    ...
    <>
      <Grid
        ...
        sx={{
          ...
          padding: {lg:"40px 20px 0 20px",xs:"40px 30px 0 30px"},
        }}
        id="FAQ"
      >
        <Grid
          ...
          <Box className='accordion-box-parent' sx={{ transform: { lg: "scale(0.8)", xs: "scale:none" } }}>
            ...
            >
              ...
              <AccordionDetails className="accord-details">
                ...
                >
                  You can buy Flash tokens directly by credit card on our
                  website or with Metamask directly.
                </Typography>
              </AccordionDetails>
            </Accordion>
            <Accordion
          ...
          <Box sx={{ transform: { lg: "scale(0.8)", xs: "scale:none" } }}>
            ...
            >
              <AccordionSummary
                ...
                id="panel2d-header"
              >
                <Typography>How can I buy Flash Token?</Typography>
              </AccordionSummary>
              <AccordionDetails className="accord-details">
                <Typography>
                  You can buy Flash tokens directly by credit card on our
            ...
            >
              ...
              >
                <Typography>
                  What are the benefits of buying Flash Token coins?
                </Typography>
              </AccordionSummary>
              <AccordionDetails className="accord-details">
                <Typography>
